...
class UserController extends Controller
{
    ...
    public function ListDirectory($proceso){
        //$proceso='2.PROCESOS-MISIONALES-(P.M.)';
    ...
    public function ListProcessDirectories(){
        //$proceso='2.PROCESOS-MISIONALES-(P.M.)';
        // directorio de calidad en `/storage/app/public/docs`
        // Obtienes los subdirectorios que están dentro del directorio del cliente
        $directorios_del_proceso = Storage::directories("/public/docs/");
        ...
        foreach ($directorios_del_proceso as $directorio_del_proceso) {
            ...
            //var_dump($tree_array);
        // devuelves la vista pasándole el array creado.
        return view('viewProcess', ['tree_array' => $tree_array]);
    }
}